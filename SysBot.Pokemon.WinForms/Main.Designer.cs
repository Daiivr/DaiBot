...
namespace SysBot.Pokemon.WinForms
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            Text = "Centro de control de DaiBot";
            ...
            ConfigureNavButton(btnNavBots, "BOTS", 0, "Administrar conexiones BOT");
            ConfigureNavButton(btnNavHub, "CONFIGURACIÓN", 1, "Configuración del sistema");
            ConfigureNavButton(btnNavLogs, "REGISTRO SISTEMA", 2, "Ver registros de actividad");
            ...
            ConfigureNavButton(btnExit, "SALIR", 3, "Salir de la aplicación");
            ...
            sidebarBottomPanel.Layout += (s, e) =>
            {
                comboBox1.Location = new Point(15, 10);
                comboBox1.Size = new Size(sidebarBottomPanel.Width - 30, 25);

                btnUpdate.Location = new Point(15, comboBox1.Bottom + 5);
                btnUpdate.Size = new Size(sidebarBottomPanel.Width - 30, 40);
            };
            ...
            titleLabel.Text = "Gestión de Bots";
            ...
            ConfigureControlButton(btnStart, "INICIAR TODO", Color.FromArgb(87, 242, 135));
            ConfigureControlButton(btnStop, "DETENER TODO", Color.FromArgb(237, 66, 69));
            ConfigureControlButton(btnReboot, "REINICIAR", Color.FromArgb(88, 101, 242));
            ...
            ConfigureSearchOption(btnCaseSensitive, "Aa", "Búsqueda sensible a mayúsculas");
            ConfigureSearchOption(btnRegex, ".*", "Búsqueda con expresiones regulares");
            ConfigureSearchOption(btnWholeWord, "Ab", "Búsqueda de palabra completa");
            ...
            btnClearLogs.Text = "BORRAR REGISTROS";
            ...
            this.Shown += (s, e) => {
                ...
                if (logsHeaderPanel != null)
                {
                    ...
                    controlButtonsPanel.PerformLayout();
                    headerPanel.PerformLayout();
                    headerPanel.Invalidate();
                    this.Shown += (s, e) => Main_Resize(this, EventArgs.Empty);

                    // Alineación forzada por si el tamaño no estaba listo
                    controlButtonsPanel.Location = new Point(
                        headerPanel.Width - controlButtonsPanel.Width - 20,
                        30
        ...
        private void ConfigureUpdateButton()
        {
            ...
            updateTooltip.SetToolTip(btnUpdate, "Verificar si hay actualizaciones");
            btnUpdate.MouseEnter += (s, e) => {
                var mainForm = (Main)btnUpdate.FindForm();
                if (mainForm != null && mainForm.hasUpdate)
                {
                    updateTooltip.SetToolTip(btnUpdate, "¡Actualización disponible! Haz clic para descargar.");
                }
                else
                {
        ...
        private void FLP_Bots_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (_currentModeImage != null)
            {
                ...
                else
                {
                    ...
                    var text = "No hay bots configurados. Agrega un bot usando el formulario de arriba.";
            ...
            {
                using var font = ScaleFont(new Font("Segoe UI", 14F, FontStyle.Regular));
                using var brush = new SolidBrush(Color.FromArgb(220, 255, 255, 255)); // Blanco brillante
                var text = "No hay bots configurados. Agrega un bot usando el formulario arriba.";
        ...
        {
            trayIcon.Icon = Icon;
            trayIcon.Text = "Centro de Control de DaiBot";
            trayIcon.Visible = false;
            ...
            trayMenuStart.Click += (s, e) => {
                ...
                LogUtil.LogInfo("Todos los bots iniciados desde la bandeja", "Bandeja");
            };
            ...
            trayMenuStop.Click += (s, e) => {
                ...
                LogUtil.LogInfo("Todos los bots detenidos desde la bandeja", "Bandeja");
            };
